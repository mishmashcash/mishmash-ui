...
export default {
  ...
  head: {
    ...
    meta: [
      ...
      { name: 'theme-color', content: '#000403' },
      {
        hid: 'description',
        name: 'description',
        content: 'Non-custodial Electroneum Privacy solution.'
      },
      {
        hid: 'og:title',
        property: 'og:title',
        content: 'MishMash.Cash'
      },
      {
        hid: 'og:description',
        property: 'og:description',
        content: 'Non-custodial, trustless, serverless, private transactions on Electroneum network'
      },
      {
        hid: 'og:url',
        property: 'og:url',
        content: 'https://mishmash.cash'
      },
      {
        hid: 'og:type',
        property: 'og:type',
      ...
      },
      {
        hid: 'og:image',
        property: 'og:image',
        content: 'https://mishmash.cash/mm.png'
      },
      {
        hid: 'description',
        name: 'description',
      ...
      },
      {
        ...
        name: 'keywords',
        content:
          'MishMash, Electroneum, ERC20, dapp, smart contract, decentralized, metamask, zksnark, zero knowledge'
      }
    ],
    link: [
   ...
   */
  loading: { color: '#37eaff', height: '5px', duration: 5000 },
  /*
   ** Global CSS
   */
