  ...
  <div class="governance-head">
    <div class="columns is-mobile is-multiline is-centered is-vcentered">
      <div class="column is-12-mobile is-6-tablet is-3-desktop">
        ...
        <div class="info-value"><number-format :value="balance" /> MASH</div>
      </div>
      <div class="column is-12-mobile is-6-tablet is-3-desktop">
        <div class="info-name">{{ $t('stakingReward.title') }}</div>
        <div class="info-value"><number-format :value="reward" /> MASH</div>
      </div>
      <div class="column is-12-mobile is-6-tablet is-3-desktop">
        <div class="info-name">{{ $t('votingPower') }}</div>
        <div class="info-value has-tooltip">
          <span><number-format :value="votingPower" /> MASH</span>
          <b-tooltip
            :label="
              `${$n(toDecimals(lockedBalance, 18))} ${$t('locked')} MASH + ${$n(
