        ...
        <div class="proposal--blocks">
            ...
            >
              <template v-slot:vote>
                <span
                  ...
                  >{{ $n(fromWeiToTorn(voterReceipts[data.id].balance)) }} MASH</span
                >
              </template>
            </i18n>
          </div>
          ...
          <div class="proposal-block">
            ...
            <div class="label">
              {{ $t('for') }}
              <span class="percent"
                ><number-format :value="data.results.for" /> MASH / {{ calculatePercent('for') }}%</span
              >
            </div>
            ...
            <div class="label">
              {{ $t('against') }}
              <span class="percent"
                ><number-format :value="data.results.against" class="value" /> MASH /
            ...
            <div class="label">
              ...
              <span class="percent"
                ><number-format :value="isQuorumCompleted ? quorumVotes : quorumResult" class="value" /> MASH
                / {{ quorumPercent }}%</span
              >
            </div>
